// Test the getAllActivities function
...
async function testGetAllActivities() {
  try {
    ...
    console.log('=== Testing getAllActivities query ===');
    ...
    console.log('Query successful. Number of records:', result.length);
    console.log('Sample record:', result[0]);
    
  } catch (error) {
    console.error('Error in getAllActivities query:', error.message);
...
module.exports = { testGetAllActivities };
