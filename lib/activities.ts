...
// Get activity by ID with all foreign key references
export async function getActivityByIdWithReferences(id: number): Promise<ActivityDetail | null> {
  try {
    ...
    console.log("Final activity detail:", JSON.stringify(activityDetail, null, 2));
